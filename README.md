# Vagrant box Debian 11 LAMP

Make a Vagrant box with Debian 11 LAMP stack, plus configure it for development.

- Host: Linux or Mac.
- Guest: Debian 11, Apache 2.4, MariaDB 10.6, PHP 8.2, Python 3.9, Ruby 2.7, Git 2.x.
...
- 64bit Debian 11 virtual machine with virtual 64GB HDD, 3GB RAM and updated LAMP stack from [Bento](https://app.vagrantup.com/bento/boxes/debian-11).
